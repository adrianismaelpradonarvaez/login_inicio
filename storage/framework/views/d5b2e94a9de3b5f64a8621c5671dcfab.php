    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="text" name="usuario" placeholder="Usuario" value="<?php echo e(old('usuario')); ?>" required>
                <input type="password" name="password" placeholder="Contraseña" required>
                <button type="submit">Ingresar</button>
            </form>

            <div class="register-link">
                <a href="<?php echo e(route('register')); ?>">¿No tienes cuenta? Regístrate aquí</a>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH D:\login_inicio\resources\views/login.blade.php ENDPATH**/ ?>