            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge <?php echo e($u->rol == 'Administrador' ? 'badge-admin' : 'badge-user'); ?>">
                                <?php echo e($u->rol); ?>

                            </span>
                        </td>
                        <td>
                            <a href="<?php echo e(route('admin.edit', $u->id)); ?>" class="btn-edit">Editar</a>
                            <?php if($u->id != session('id')): ?>
                                <a href="<?php echo e(route('admin.delete', $u->id)); ?>" class="btn-delete" onclick="return confirm('¿Eliminar este usuario?')">Eliminar</a>
                            <?php endif; ?>
                        </td>
                    </tr>
...
</html><?php /**PATH D:\login_inicio\resources\views/admin/index.blade.php ENDPATH**/ ?>